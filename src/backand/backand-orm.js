...
function BackandOptions(config) {
    this.url = config.url;
...
BackandOptions.prototype.getQueryString = function () {
    return window.location.href.slice(window.location.href.indexOf('?') + 1);
};

BackandOptions.prototype.objectToQueryString = function (obj) {
    var str = [];
    for (var p in obj)
...
BackandOptions.prototype.setNetworkMethods = function () {
    this.json = '';
    this.file = '';
};
